...
description: >
  Use when receiving code review feedback, before implementing suggestions. Requires
  technical rigor and verification, not performative agreement or blind implementation.
  Triggers on "review feedback", "reviewer said", "PR comments", "address review",
  "fix review comments".
---
...
3. Test each fix individually via exec
