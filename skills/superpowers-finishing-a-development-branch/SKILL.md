...
description: >
  ...
  integrate the work. Guides completion by presenting structured options for merge, PR,
  or cleanup. Triggers on "done implementing", "ready to merge", "finish up", "wrap up",
  "complete the branch", "create PR".
---
...
# Verify tests on merged result via exec
...
**Do NOT delete the branch** — the user needs it to iterate on PR feedback.
