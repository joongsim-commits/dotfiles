...
Use this template when dispatching an implementer sub-agent via `spawn_subagent`.
...
**How to escalate:** Report back with status BLOCKED or NEEDS_CONTEXT. Describe specifically what you're stuck on.
